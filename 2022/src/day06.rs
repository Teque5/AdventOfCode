...
use std::fs; // allows use of combinations / permutations
...
pub fn solve() {
    ...
    // compare 4 values
    assert_eq!(
        part("input/06_train", 4),
        common::read_lines_as::<i32>("input/06_val1")[0]
    );
    ...
    assert_eq!(
        ...
        common::read_lines_as::<i32>("input/06_val2")[0]
    );
